...
@section('title', 'Products - SerbukKopi.id')
	...
	<div class="popular-product-area wrapper-padding-3 pt-115 pb-115">
		<div class="container-fluid">
			<div class="section-title-6 text-center mb-50">
				...
				<p>Produk kopi bubuk yang banyak diminati karena rasa yang khas, aroma yang menggoda, dan kualitasnya yang terjaga, cocok untuk dinikmati setiap hari atau sebagai pilihan untuk hadiah.</p>
			</div>
