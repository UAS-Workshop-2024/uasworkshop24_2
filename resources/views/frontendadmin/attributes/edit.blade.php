                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <!-- Edit Icon -->
                                        <a href="{{ route('admin.attributes.attribute_options.edit', [$attribute, $attribute_option]) }}" class="me-2">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <!-- Delete Icon -->
                                        <form onsubmit="return confirm('Are you sure?')" action="{{ route('admin.attributes.attribute_options.destroy', [$attribute, $attribute_option]) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
