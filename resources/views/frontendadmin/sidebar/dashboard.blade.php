    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
          <img src="{{ asset('/asetbaru/assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="main_logo">
          <span class="ms-1 font-weight-bold">Management User Web</span>
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <div class="card-body">
                    <div class="badges">
                        ...
                        <span>Name: <span class="fw-bolder">{{ Auth::user()->nama_user }}</span></span>
                        <hr>
                        <span>Role Name:</span>
                        ...
                        @if (Auth::user()->id_jenis_user == 2)
                            ...
                            <hr>
                            <span>Role Name:</span>
                            <span class="badge bg-info">User Umum</span>
                        @endif
            ...
            <a class="nav-link {{ Request::routeIs($menu->menu_link) ? 'active' : '' }}" id="dashboard-link" href="{{ route($menu->menu_link) }}">
              ...
              <span class="nav-link-text ms-1">{{ $menu->menu_name }}</span>
            </a>
          </li>
          @endforeach
                  <li class="nav-item">
